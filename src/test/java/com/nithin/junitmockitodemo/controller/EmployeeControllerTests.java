...
import com.nithin.junitmockitodemo.service.EmployeeService;
...
public class EmployeeControllerTests {
	...
	public void givenEmployeeId_whenGetEmployeeById_thenReturnEmployeeObject() throws Exception {
		// given - precondition or setup
		long employeeId = 1L;
		Employee employee = Employee.builder().id(employeeId).firstName("Ramesh").lastName("Fadatare")
	...
	public void givenUpdatedEmployee_whenUpdateEmployee_thenReturnUpdateEmployeeObject() throws Exception {
		// given - precondition or setup
		long employeeId = 1L;
		Employee savedEmployee = Employee.builder().id(1).firstName("Ramesh").lastName("Fadatare")
				.email("ramesh@gmail.com").build();

		Employee updatedEmployee = Employee.builder().id(1).firstName("Ram").lastName("Jadhav").email("ram@gmail.com")
				.build();

		Mockito.when(employeeService.getEmployeeById(employeeId)).thenReturn(Optional.of(savedEmployee));
	...
	public void givenUpdatedEmployee_whenUpdateEmployee_thenReturn404() throws Exception {
		// given - precondition or setup
		long employeeId = 1L;
		Employee savedEmployee = Employee.builder().id(1).firstName("Ramesh").lastName("Fadatare").email("ramesh@gmail.com")
				.build();
