...
public class EmployeeRespositoryTests {
	...
	public void givenEmployeeObject_whenSave_thenReturnSavedEmployee() {
		...
		Employee employee = Employee.builder().firstName("Ramesh").lastName("Ramesh").email("ramesh@gmail,com").build();
	...
	public void givenEmployeesList_whenFindAll_thenEmployeesList() {
		...
		Employee employee1 = Employee.builder().firstName("John").lastName("Cena").email("cena@gmail,com").build();
	...
	public void givenEmployeeObject_whenDelete_thenRemoveEmployee() {
		// given - precondition or setup
		Employee employee = Employee.builder().id(1).firstName("Ramesh").lastName("Fadatare").email("ramesh@gmail,com")
				.build();
		employeeRepository.save(employee);
